export function FloatingCTA() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center gap-2 bg-cta hover:bg-cta-hover text-cta-foreground px-5 py-3.5 rounded-full shadow-lg shadow-cta/30 text-sm font-bold transition-all hover:scale-105 active:scale-95 md:bottom-8 md:right-8"
