...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "ФОП Моголюк — Спецодяг, взуття та супутні товари" },
      { property: "og:description", content: "Продаж спецодягу, робочого взуття, протипожежного інвентарю. ФОП Моголюк — якість та надійність." },
      { property: "og:type", content: "website" },
      { name: "twitter:title", content: "ФОП Моголюк — Спецодяг, взуття та супутні товари" },
      { name: "twitter:description", content: "Продаж спецодягу, робочого взуття, протипожежного інвентарю. ФОП Моголюк — якість та надійність." },
      { name: "twitter:card", content: "summary" },
    ],
    links: [
      { rel: "stylesheet", href: appCss },
      { rel: "preconnect", href: "https://fonts.googleapis.com" },
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800&family=Montserrat:wght@500;600;700;800;900&display=swap" },
    ],
  }),
